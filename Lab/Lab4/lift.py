def main():
    ...
    if lift_1_floor == 'G' and lift_1_status == "moving down":
        print("Lift 1 will come to pick you up.")
    elif lift_2_floor == 'G' and lift_2_status == "moving down":
        print("Lift 2 will come to pick you up.")
    elif lift_3_floor == 'G' and lift_3_status == "moving down":
        print("Lift 3 will come to pick you up.")
        
    elif lift_1_floor == 'G' and lift_1_status == "stopped":
        print("Lift 1 will come to pick you up.")
    elif lift_2_floor == 'G' and lift_2_status == "stopped":
        print("Lift 2 will come to pick you up.")
    elif lift_3_floor == 'G' and lift_3_status == "stopped":
        print("Lift 3 will come to pick you up.")
        
    elif lift_1_floor == '10' and lift_1_status == "moving down":
        print("Lift 1 will come to pick you up.")
    elif lift_2_floor == '10' and lift_2_status == "moving down":
        print("Lift 2 will come to pick you up.")
    elif lift_3_floor == '10' and lift_3_status == "moving down":
        print("Lift 3 will come to pick you up.")
        
    elif lift_1_floor == '10' and lift_1_status == "stopped":
        print("Lift 1 will come to pick you up.")
    elif lift_2_floor == '10' and lift_2_status == "stopped":
        print("Lift 2 will come to pick you up.")
    elif lift_3_floor == '10' and lift_3_status == "stopped":
        print("Lift 3 will come to pick you up.")
        
    elif lift_1_floor == '10' and lift_1_status == "moving up":
        print("Lift 1 will come to pick you up.")
    elif lift_2_floor == '10' and lift_2_status == "moving up":
        print("Lift 2 will come to pick you up.")
    elif lift_3_floor == '10' and lift_3_status == "moving up":
        print("Lift 3 will come to pick you up.")
    
    elif lift_1_floor == 'G' and lift_1_status == "moving up":
        print("Lift 1 will come to pick you up.")
    elif lift_2_floor == 'G' and lift_2_status == "moving up":
        print("Lift 2 will come to pick you up.")
    elif lift_3_floor == 'G' and lift_3_status == "moving up":
        print("Lift 3 will come to pick you up.")
